...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className="flex w-full h-12 items-center rounded-[12px] bg-surface-container-low p-1 text-on-surface-variant gap-1 shadow-sm overflow-x-auto scrollbar-hide"
    {...props}
  />
));
