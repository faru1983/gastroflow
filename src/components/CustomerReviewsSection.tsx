        ...
        <>
            <Card className="h-full flex flex-col">
                ...
                <CardContent className="flex-grow flex flex-col justify-between p-6">
                    <div 
                        className="text-center mb-6 p-4 rounded-lg hover:bg-muted cursor-pointer"
                        onClick={() => setReviewModalOpen(true)}
                    >
                        <p className="font-bold text-lg">Calificación en Google</p>
                        <div className="flex items-center justify-center gap-2 mt-1">
                            <p className="text-xl font-bold">{GOOGLE_RATING}</p>
                            <div className="flex">
                                {renderStars(GOOGLE_RATING)}
                            </div>
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">{REVIEW_COUNT} reseñas</p>
                    </div>
